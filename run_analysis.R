...
##  Step 1: Merges the Training and Testing Sets ##
...
## It's done reading the activity_labels.txt ##
...
## Replacing the names in the data set ##
...
## Step 5:  Tidy data from the last variables ##
## Tidy data as output ##
